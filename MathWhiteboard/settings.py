"""
Django settings for MathWhiteboard project.
...
SECRET_KEY = 'django-insecure-ntw=--1rcg4sb0ic$728$alaxk#p1)7+p#iek50qe6r_50^@$o'
...
ROOT_URLCONF = 'MathWhiteboard.urls'
...
WSGI_APPLICATION = 'MathWhiteboard.wsgi.application'
